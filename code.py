# INSTALLATION OF REQUIRED IBRARIES
!pip install pymongo
...
icon = Image.open("/content/Youtube_logo.png")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By Badhrinath S",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *Badhrinath S!*"""})
...
# FOR GETTING TUNNEL PASSWORD / IP ADDRESS
!wget -q -o - https://loca.lt/localtunnelpassword

# RUNNING STREAMLIT
!streamlit run app.py & npx localtunnel --port 8501

# BUILDING CONNECTION WITH YOUTUBE API
api_key = 'AIzaSyCqo5UgtgExXsjjqxVbIIX5NU6Ef1jbHSA' #"AIzaSyDQYpHKd36QOoBloxRsemSzSITMepCzoTU"
...
if selected == "Home":
    # Title Image
    st.image("/content/image27_frqkzv.png")
